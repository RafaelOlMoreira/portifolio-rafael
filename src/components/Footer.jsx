...
function Footer() {
    return (
        <div className='font-poppins h-auto bg-[#181818]'>
            <div className='border-t-1 border-[#e8e8e81e] py-5'>
                <div className='grid grid-rows-2 md:grid-cols-2 md:grid-rows-1 items-center mx-auto'>
                    ...
                    <div className='flex py-5'>
                        ...
                        <div className='ml-auto mx-auto'>
                            <a href="https://www.linkedin.com/in/rafaelolmoreira/">
