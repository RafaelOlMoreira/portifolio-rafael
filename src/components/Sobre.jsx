      ...
      <div className='xl:ml-15 mx-auto'>
        <h1 className='fade-in-esquerda block tracking-wide text-[#e8e8e8] text-center text-nowrap object-cover
          ...
          <p className='text-xl text-center text-[#e8e8e8]
                        md:text-2xl lg:text-3xl xl:text-4xl xl:text-start'>
            Sou um Dev
            <TypeAnimation
              sequence={[
                1500,
        ...
        <div className='block sm:flex gap-x-4 fade-in-esquerda'>
          <button className='flex mx-auto xl:mx-0 text-sm mt-4 gap-x-1 items-center border-1 p-1.5 px-3.5 rounded-md text-[#e8e8e8] border-[#e8e8e81e] hover:bg-[#e8e8e81e] hover:cursor-pointer'>
          ...
          <button className='flex mx-auto xl:mx-0 text-sm mt-4 gap-x-1 items-center border-1 p-1.5 px-3.5 rounded-md text-black bg-[#e8e8e8] border-[#e8e8e81e] hover:bg-[#e8e8e8cb] hover:cursor-pointer'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
